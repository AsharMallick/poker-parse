...
exports.IPokerStrategyService = void 0;
const base_1 = require("./base");
const { parseStringInt, parseStringFloat, } = require('../../../common/utility/stringUtils');
class IPokerStrategyService extends base_1.BaseParser {
    constructor() {
        super();
    }
    parse(sections) {
    ...
    parseTable(line) {
        const match = line.match(/^Table\s+\S[\d,]+\sGTD\s\-\sRebuy,\s(\d+),\s(\d+)/);
    ...
    handleStreet(line) {
        ...
        for (const street of streetRegex) {
            ...
            if (streetMatch) {
                this.handData.communityCards.push(...this.getCardsDetailIPoker(streetMatch[1].trim().split(' ')));
            }
        }
    }
    parseHoleCards(line) {
    ...
    iPokerSectionParser(chunks) {
        ...
        const emptyRegex = /GAME #[0-9]+ Version:[\d.]+ Uncalled:[YN] Texas Hold'em NL  Tournament/;
...
exports.IPokerStrategyService = IPokerStrategyService;
//# sourceMappingURL=ipoker-strategy.service.js.map