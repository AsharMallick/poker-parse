...
declare class PokerStarsStrategyService extends BaseParser {
    ...
    pokerStarSectionParser(chunks: string[]): import("../interfaces/parsed-hand-history.interface").ParsedHandHistory;
}
